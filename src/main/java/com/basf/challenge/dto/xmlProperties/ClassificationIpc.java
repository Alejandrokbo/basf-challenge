 ...
 *       &lt;sequence&gt;
 *         &lt;element name="main-classification" type="{}ipc-main-classification-type" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="further-classification" type="{}ipc-further-classification-type" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class ClassificationIpc {
    ...
    protected List<IpcMainClassificationType> mainClassification;
    @XmlElement(name = "further-classification")
    protected List<IpcFurtherClassificationType> furtherClassification;
     ...
     * {@link IpcMainClassificationType }
     */
    public List<IpcMainClassificationType> getMainClassification() {
        if (mainClassification == null) {
            mainClassification = new ArrayList<IpcMainClassificationType>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link IpcFurtherClassificationType }
     */
    public List<IpcFurtherClassificationType> getFurtherClassification() {
        if (furtherClassification == null) {
            furtherClassification = new ArrayList<IpcFurtherClassificationType>();
        }
