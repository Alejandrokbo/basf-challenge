 ...
 *
 *
 * <p>Clase Java para national-further-classification-type complex type.
 *
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 *
 * <pre>
 * &lt;complexType name="national-further-classification-type"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "national-further-classification-type", propOrder = {
        "text",
        "edition",
        "section",
        "clazz",
...
public class NationalFurtherClassificationType {
